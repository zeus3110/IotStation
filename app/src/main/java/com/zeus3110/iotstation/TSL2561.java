...
public class TSL2561 implements AutoCloseable {
     ...
     * @throws IOException
     */
    public TSL2561(String bus, @TSL2561.SlaveAddress int Address) throws IOException {
    ...
    1.30 < CH1/CH0  Lux = 0
     */
    float GetLuxData() throws IOException {
        double lux0, lux1;
        double ratio;
        double lux;
        int ch0, ch1;
    ...
    // Timing Register
    public int SetGainAndIntegtime(@TSL2561.SensorGainReg int gain, @TSL2561.SensorIntegTimeReg int time) throws IOException {
        int param;
        param = gain | time;
